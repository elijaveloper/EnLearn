<html !DOCTYPE>
	...
	<body>
		<div id="game_container">
			...
			<div class="notif_container" style="text-align:center;">
    			<div class="bar_stats" id="modal_caps">Press the <span class="btn_letter_wrong">CapsLock</span></div>
    			<div class="bar_stats" id="modal_shift">Press the <span class="btn_letter_stats">Shift</span></div>
			</div>
			<div id="container">
				<ul id="keyboard">
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$.getJSON("/test/data/level_2.json",function(data){
			...
			$("#scorespace_nextLesson").on("click",function(){
				if(levelIndex == numberOfLevels-1){
					window.location.href = "http://www.abcya.com/second_grade_computers.htm";
				}else{
